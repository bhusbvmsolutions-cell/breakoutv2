...
const aboutUsApiRoutes = require('./api/aboutus.routes');
const LogoAprRoutes = require('./api/logo.routes');
...
router.use('/api/about-us', aboutUsApiRoutes);
router.use('/api/logos', LogoAprRoutes);
