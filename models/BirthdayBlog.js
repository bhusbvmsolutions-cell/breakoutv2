...
module.exports = (sequelize, DataTypes) => {
  const BirthdayBlog = sequelize.define(
    'BirthdayBlog',
    {
      ...
      glance_heading: DataTypes.STRING,
      glance_content: DataTypes.TEXT,
      icons_heading: DataTypes.STRING,
      icons_description: DataTypes.TEXT,
